...
var TimeColumn = (function(_Component) {
  ...
  TimeColumn.prototype.renderTimeSliceGroup = function renderTimeSliceGroup(
    key,
    isNow,
    date,
    resource
  ...
  TimeColumn.prototype.render = function render() {
    ...
    for (var i = 0; i < numGroups; i++) {
      isNow = _dates2.default.inRange(
        now,
        date,
        _dates2.default.add(next, groupLengthInMinutes - 1, 'minutes'),
        'minutes'
      )
